...
help:
	@echo "Orca SDK - Simple Development Commands:"
...
example:
	...
	@if [ -z "$$ORCA_API_KEY" ]; then \
		echo "❌ ORCA_API_KEY environment variable not set."; \
		echo "💡 Set it with: export ORCA_API_KEY=your_api_key"; \
		exit 1; \
	fi
